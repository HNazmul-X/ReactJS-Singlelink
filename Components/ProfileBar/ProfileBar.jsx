          ...
          <div className="d-flex align-items-center p-3">
            ...
            <div className="right">
              <h6 className="mb-1 font-weight-bold">
                Gurdeep Singh{" "}
                <i className="feather-check-circle text-success"></i>
              </h6>
        ...
        <div className="bg-white profile-details">
            ...
            <a className="d-flex w-100 align-items-center border-bottom px-3 py-4">
              <div className="left mr-3">
                <h6 className="font-weight-bold m-0 text-dark">
                  <i className="feather-truck bg-danger text-white p-2 rounded-circle mr-2"></i>{" "}
                  Delivery Support
                </h6>
              </div>
              <div className="right ml-auto">
          ...
          <Link href="/contacts">
            <a className="d-flex w-100 align-items-center border-bottom px-3 py-4">
              <div className="left mr-3">
                <h6 className="font-weight-bold m-0 text-dark">
                  <i className="feather-phone bg-primary text-white p-2 rounded-circle mr-2"></i>{" "}
                  Contact
                </h6>
              </div>
              <div className="right ml-auto">
          ...
          <Link href="/terms">
            <a className="d-flex w-100 align-items-center border-bottom px-3 py-4">
              <div className="left mr-3">
                <h6 className="font-weight-bold m-0 text-dark">
                  <i className="feather-info bg-success text-white p-2 rounded-circle mr-2"></i>{" "}
                  Term of use
                </h6>
              </div>
              <div className="right ml-auto">
          ...
          <Link href="/privacy">
            ...
            >
              <div className="left mr-3">
                <h6 className="font-weight-bold m-0 text-dark">
                  <i className="feather-lock bg-warning text-white p-2 rounded-circle mr-2"></i>{" "}
                  Privacy policy
                </h6>
              </div>
              <div className="right ml-auto">
