      ...
      <div className="rounded shadow-sm">
        <div className="osahan-privacy bg-white rounded shadow-sm p-4">
          <div id="intro" className="mb-4">
            {/* <!-- Title --> */}
            <div className="mb-3">
              <h2 className="h5">Welcome to Swiggiweb</h2>
            </div>
            {/* <!-- End Title --> */}
            <p>
              Thanks for using our products and services {/*"Services"*/}. The
              Services are provided by Pixeel Ltd. {/*"Swiggiweb"*/}, located at 153
          ...
          <div id="services" className="mb-4">
            ...
            <p>
              ...
              in which you provide the data. In particular:
            </p>
            <ul className="text-secondary">
              <li className="pb-2">
                When you register for a Swiggiweb account we collect your full
              ...
              <li className="pb-2">
                When you use the {/*"Remember Me"*/} feature of Swiggiweb Checkout, we
                collect your email address, payment card number, CVC code and
                expiration date.
              </li>
            </ul>
            <p>
              When you respond to Swiggiweb emails or surveys we collect your
              email address, name and any other information you choose to
              include in the body of your email or responses. If you contact us
              by phone, we will collect the phone number you use to call
              Swiggiweb. If you contact us by phone as a Swiggiweb User, we may
            ...
            <p>
              ...
              use Google Analytics on our Sites to help us analyze Your use of
              our Sites and diagnose technical issues.
            </p>
            <p>
          ...
          <div id="privacy" className="mb-4">
            ...
            {/* <!-- End Title --> */}
            <p>
              Swiggiwebs privacy policies explain how we treat your personal
              data and protect your privacy when you use our Services. By using
              our Services, you agree that Swiggiweb - Online Food Ordering
              Website Template can use such data in accordance with our privacy
              policies.
            </p>
            <p>
            ...
            <p>
              ...
              about submitting notices and Swiggiwebs policy about responding
              to notices in <a href="help.html">our Help Center</a>.
            </p>
          </div>
          <div id="yourContent" className="active">
            ...
            <p>
              ...
              through our Services, you give Swiggiweb (and those we work with)
