        ...
        <>
            <div className="bg-white p-3 mb-3 restaurant-detailed-ratings-and-reviews shadow-sm rounded">
                ...
                <div className="reviews-members py-3">
                    <div className="media">
                        <a href="#">
                            <img alt="#" src="/img/reviewer1.png" className="mr-3 rounded-pill" />
                        </a>
                        <div className="media-body">
                            ...
                            <div className="reviews-members-body">
                                <p>
                                    Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classNameNameical Latin literature from 45 BC, making it over 2000
                                    years old.
                                </p>
                            </div>
                            <div className="reviews-members-footer">
                                ...
                                <span className="total-like-user-main ml-2" dir="rtl">
                                    <a href="#" aria-describedby="tooltip-top0">
                                        <img alt="#" src="/img/reviewer3.png" className="total-like-user rounded-pill" />
                                    </a>
                                    <a href="#" aria-describedby="tooltip-top1">
                                        <img alt="#" src="/img/reviewer4.png" className="total-like-user rounded-pill" />
                                    </a>
                                    <a href="#">
                                        <img alt="#" src="/img/reviewer5.png" className="total-like-user rounded-pill" />
                                    </a>
                                    <a href="#" aria-describedby="tooltip-top3">
                                        <img alt="#" src="/img/reviewer6.png" className="total-like-user rounded-pill" />
                                    </a>
                                </span>
                            </div>
                        </div>
                ...
                <div className="reviews-members py-3">
                    <div className="media">
                        <a href="#">
                            <img alt="#" src="/img/reviewer2.png" className="mr-3 rounded-pill" />
                        </a>
                        <div className="media-body">
                            <div className="reviews-members-header">
                                <div className="star-rating float-right">
